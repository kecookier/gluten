 ...
 */
package io.glutenproject.sql.shims.spark30

import io.glutenproject.sql.shims.{SparkShimDescriptor, SparkShims}
import io.glutenproject.sql.shims.spark30.SparkShimProvider.DESCRIPTOR

object SparkShimProvider {
  val DESCRIPTOR = SparkShimDescriptor(3, 0, 2)
}
